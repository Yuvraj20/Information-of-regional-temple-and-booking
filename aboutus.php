...
<html lang = "en">
	<head>
		<title>Rest House Online Reservation</title>
		<meta charset = "utf-8" />
	...
	<nav style = "background-color:rgba(0, 0, 0, 0.1);" class = "navbar navbar-default">
		<div  class = "container-fluid">
			<div class = "navbar-header">
				<a class = "navbar-brand" >Rest House Online Reservation</a>
			</div>
		</div>
	</nav>	
	<ul id = "menu">
	...
	<div style = "margin-left:0;" class = "container">
		<div class = "panel panel-default">
			<div class = "panel-body">
				...
				<p style = "position:relative; float:left; width:850px;"><h1>Group Members:</h1>
   <li>Ashwin Nair A-39
   <li>Yuvraj Patel A-49
   <li>Deepanshu Pandita A-44
   <li>Nikhil Mathapati A-32<br>
